    ...
    <div className={styles.indexPage}>
      <main className={styles.main}>
        <div className={styles.flexCenterCol}>
          <Text h1>Buffered.link</Text>
          <Text style={{ fontFamily: "cursive" }}>Your text buffer</Text>

          <span style={{ display: "flex", flexDirection: "row" }}>
            <Link href="/docs">
              <Button auto>Docs</Button>
            </Link>
            <Spacer h={0} w={2} />
            <Link href="/app">
      ...
      <div style={{ margin: "0 1em" }}>
        ...
        <Text>
          I originally built the tool for{" "}
          <Link
        ...
        <Text h2>Buffered.link is for you if;</Text>
        <ul>
          <li>
            You constantly share text and snippets between two or more devices
          </li>
        ...
        <Text h2>Buffered.link is not for you if;</Text>
        <ul>
          <li>Your devices have no access to the internet</li>
          <li>
            You share huge files. Try{" "}
            <Link href="https://transfer.sh/">transfer.sh</Link>{" "}
          </li>
        </ul>
      </div>
